...
def createSaveMetricsPlot(modelH,modName,data,model):
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['dig1_acc'])
    plt.plot(modelH.history['val_dig1_acc'])
    plt.title('Digit1 accuracy')
    plt.ylabel('accuracy')
    plt.xlabel('epoch')
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['dig2_acc'])
    plt.plot(modelH.history['val_dig2_acc'])
    plt.title('Digit2 accuracy')
    plt.ylabel('accuracy')
    plt.xlabel('epoch')
    plt.legend(['train', 'val'], loc='upper left')
    plt.draw()
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['dig3_acc'])
    plt.plot(modelH.history['val_dig3_acc'])
    plt.title('Digit3 accuracy')
    plt.ylabel('accuracy')
    plt.xlabel('epoch')
    plt.legend(['train', 'val'], loc='upper left')
    plt.draw()
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['dig4_acc'])
    plt.plot(modelH.history['val_dig4_acc'])
    plt.title('Digit4 accuracy')
    plt.ylabel('accuracy')
    plt.xlabel('epoch')
    plt.legend(['train', 'val'], loc='upper left')
    plt.draw()
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['num_acc'])
    plt.plot(modelH.history['val_num_acc'])
    plt.title('model accuracy')
    plt.ylabel('Number Digits Accuracy')
    plt.xlabel('epoch')
    plt.legend(['train', 'val'], loc='upper left')
    plt.draw()
    ...
    plt.show()
    fig1 = plt.gcf()
    plt.plot(modelH.history['loss'])
    plt.plot(modelH.history['val_loss'])
    ...
    plt.show()
    fig1 = plt.gcf()
    plt.plot(modelH.history['dig1_loss'])
    plt.plot(modelH.history["val_dig1_loss"])
    plt.title('Dig1 loss')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    ...
    plt.show()
    fig1 = plt.gcf()
    plt.plot(modelH.history['dig2_loss'])
    plt.plot(modelH.history["val_dig2_loss"])
    plt.title('Dig2 loss')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    ...
    plt.show()
    fig1 = plt.gcf()
    plt.plot(modelH.history['dig3_loss'])
    plt.plot(modelH.history["val_dig3_loss"])
    plt.title('Dig3 loss')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    ...
    plt.show()
    fig1 = plt.gcf()
    plt.plot(modelH.history['dig4_loss'])
    plt.plot(modelH.history["val_dig4_loss"])
    plt.title('Dig4 loss')
    plt.ylabel('loss')
    plt.xlabel('epoch')
    plt.legend(['train', 'validation'], loc='upper left')
    ...
    fig1 = plt.gcf()
    plt.ylim([0,1])
    plt.plot(modelH.history['nC_acc'])
    plt.plot(modelH.history['val_nC_acc'])
